    ...
    <div>
      <div className="stage">
        <div className="stage-content">
          <h1>OLBERTA GAMES</h1>
          <p>
            Olberta, powered by Rawg API, is your hub for top games. We offer a
            comprehensive collection for PC, Xbox, and PlayStation, including
            the latest releases and less favored titles. The Rawg API
